...
import 'package:clean_architecture_weather/weather/domain/usecases/get_wether_by_country.dart';
import 'package:flutter/material.dart';

void main() async{
  BaseRemoteDataSource baseRemoteDataSource=RemoteDataSource();
  BaseWeatherRepository baseWeatherRepository=WeatherRepository(baseRemoteDataSource);
  WeatherEntity weatherEntity=await GetWeatherByCountryName(baseWeatherRepository).execute('egypt');
  debugPrint('$weatherEntity');
  runApp(const MyApp());
}
